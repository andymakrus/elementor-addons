...
class TZ_Helper{
	...
	public static function get_template( $template_name, $args = array(), $template_path = '', $default_path = '' ) {
		...
		if ( ! file_exists( $located ) ) {
			...
			_doing_it_wrong( __FUNCTION__, sprintf( esc_html__( '%s does not exist.', 'dici-feature-pack' ), '<code>' . $located . '</code>' ), DICI_FEATURE_PACK_VERSION );
			return;
		}
	...
	public static function plugin_path() {
		return untrailingslashit( DICI_FEATURE_PACK_ROOT );
	}
