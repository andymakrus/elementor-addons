 ...
 * @since 1.0.0
 */
class Widget_TZ_Icon_Box extends Widget_Base {
	...
	public function get_title() {
		return __( 'Icon Box', 'dici-feature-pack' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_icon',
			[
				'label' => __( 'Icon Box', 'dici-feature-pack' ),
			]
		);
		...
		$this->add_control(
			'icon',
			[
				'label' => __( 'Choose Icon', 'dici-feature-pack' ),
				'type' => 'icontz',
				'default' => 'tz-icon-piggy-bank-1',
			]
		);
		...
		$this->add_control(
			'title_text',
			[
				'label' => __( 'Title & Description', 'dici-feature-pack' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
				'default' => __( 'This is the heading', 'dici-feature-pack' ),
				'placeholder' => __( 'Enter your title', 'dici-feature-pack' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'dici-feature-pack' ),
				'placeholder' => __( 'Enter your description', 'dici-feature-pack' ),
				'rows' => 10,
				'separator' => 'none',
				'show_label' => false,
			]
		...
		$this->add_control(
			'position',
			[
				'label' => __( 'Icon Position', 'dici-feature-pack' ),
				...
				'options' => [
					...
					'top' => [
						'title' => __( 'Top', 'dici-feature-pack' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Vertical Alignment', 'dici-feature-pack' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
		...
		$this->add_control(
			'heading_description',
			[
				'label' => __( 'Description', 'dici-feature-pack' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
